package com.bocsoft.test;

import com.gin.Plugin;
...
public class PluginManager {
    ...
    private static String packagename = "com.gin.Plugin1";
    ...
    public void doSome(String pluginName){
        ...
        try{
            ...
            ins.doSome();
    /*        Class clazz = this.pluginMap.get(pluginName).loadClass(packagename);
            Plugin ins = (Plugin)clazz.newInstance();
            ins.doSome();*/
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void loadPlugin(String pluginName){
        ...
        String pluginurl = "jar:file:/Users/Jean/Work/HDSS/JavaHotDeploy/PluginClassLoader/lib/"+pluginName+".jar!/";
        URL url = null;
        try {
